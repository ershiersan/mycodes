...
class codes
{
     ...
     */
    protected $current = 1;
    protected function getCodingMsgByIndex($action='verify') {
...
//        echo $interference."|".$step."|".$length."|".$width."\t";
     ...
     * @return string
     **/
    /*protected function disruptOrder($bin, $params) {
     ...
     * @return string
     **/
    /*protected function recoverOrder($endMix, $params) {
     ...
     * 两个二进制串混合
     **/
    /*protected function implodeBins($strBin1, $strBin2) {
...
//        return strrev($binReturn);
     ...
     **/
    /*protected function explodeBins($binMix, $arrLength=[14, 14]) {
     ...
     * @return null
     */
    /*protected function getGarbleBin($salt, $number, $garble_bin_length) {
